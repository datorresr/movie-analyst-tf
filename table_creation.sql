...
CREATE TABLE movie_db.moviereview (title VARCHAR(255) PRIMARY KEY, release_year VARCHAR(255), score INTEGER, reviewer VARCHAR(255), FOREIGN KEY (reviewer) REFERENCES reviewer(name) ON DELETE CASCADE);
...
INSERT INTO movie_db.reviewer (name, avatar, publication) VALUES ('Mindy Lee','https://s3.amazonaws.com/uifaces/faces/twitter/laurengray/128.jpg','Movies Games');
...
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Deadpool', '2016', 11, 'Robert Smith');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Thor: Ragnarok', '2017', 7, 'Chris Harris');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('It', '2017', 8, 'Janet Garcia');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Dunkirk', '2017', 8, 'Andrew West');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Logan', '2017', 8, 'Mindy Lee');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Batman V Superman', '2016', 6, 'Martin Thomas');
INSERT INTO movie_db.moviereview (title, release_year, score, reviewer) VALUES ('Mad Max: Fury Road', '2015', 6, 'Anthony Miller');