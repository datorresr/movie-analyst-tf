resource "aws_security_group" "SG_LB_EXT_FE" {
  ...
  name = "${var.env}_${var.servicio}_SG_LB_EXT_FE"
...
resource "aws_security_group" "SG_FE_EC2" {
  ...
  name = "${var.env}_${var.servicio}_SG_FE_EC2"
  vpc_id      = var.VPCDevOpsRampUp
...
resource "aws_security_group" "SG_LB_INT_BE" {
  ...
  name = "${var.env}_${var.servicio}_SG_LB_INT_BE"
  vpc_id      = var.VPCDevOpsRampUp
...
resource "aws_security_group" "SG_BE_EC2" {
  ...
  name = "${var.env}_${var.servicio}_SG_BE_EC2"
  vpc_id      = var.VPCDevOpsRampUp
...
resource "aws_security_group" "SG_RDS" {
  ...
  name = "${var.env}_${var.servicio}_SG_RDS"
  vpc_id      = var.VPCDevOpsRampUp
